...
<html class="index">
	<head>
		...
		<link rel="stylesheet" href="<c:url value='/resources/css/mb/jquery.mobile-1.2.0.min.css' />" />
		<link type="text/css" rel="stylesheet" href="<c:url value='/resources/css/mb/demo.css' />" />
		<link type="text/css" rel="stylesheet" href="<c:url value='/resources/css/mb/jquery.mmenu.css' />" />
		<link type="text/css" rel="stylesheet" href="<c:url value='/resources/css/mb/jquery.mmenu.css' />" />

		<script type="text/javascript" src="<c:url value='/resources/js/jquery-1.10.2.js' />"></script>
		<script type="text/javascript" src="<c:url value='/resources/js/jquery.mmenu.js' />"></script>
	...
	<body>
		<div data-role="page">
			...
			<div id="content" data-role="content">
				<img alt="logo" src="<c:url value='/resources/img/yun.jpg' />">
				<ul data-icon="star" data-inset="true" data-role="listview" class="ui-listview ui-listview-inset ui-corner-all ui-shadow">
					<li data-role="list-divider" role="heading" class="ui-li ui-li-divider ui-bar-b ui-corner-top">企业动态</li>
					<li data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="div" data-icon="arrow-r" 
						data-iconpos="right" data-theme="c" class="ui-btn ui-btn-icon-right ui-li-has-arrow ui-li ui-li-has-count ui-btn-up-c">
					...
					<li data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="div" data-icon="arrow-r" 
						data-iconpos="right" data-theme="c" class="ui-btn ui-btn-icon-right ui-li-has-arrow ui-li ui-li-has-count ui-btn-up-c">
						<a href="index.html" class="ui-link-inherit">XXXX科技多项专利申请已通过初审</a>
					</li>
					<li data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="div" data-icon="arrow-r" 
						data-iconpos="right" data-theme="c" class="ui-btn ui-btn-icon-right ui-li-has-arrow ui-li ui-li-has-count ui-btn-up-c">
						<a href="index.html" class="ui-link-inherit">XX大学教授来XXXX参观交流</a>
					</li>
				</ul>
				<ul data-icon="star" data-inset="true" data-role="listview" class="ui-listview ui-listview-inset ui-corner-all ui-shadow">
					<li data-role="list-divider" role="heading" class="ui-li ui-li-divider ui-bar-b ui-corner-top">企业招聘</li>
					<li data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="div" data-icon="arrow-r" 
						data-iconpos="right" data-theme="c" class="ui-btn ui-btn-icon-right ui-li-has-arrow ui-li ui-li-has-count ui-btn-up-c">
						<a href="index.html" class="ui-link-inherit">软件工程师</a>
					</li>
					<li data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="div" data-icon="arrow-r" 
						data-iconpos="right" data-theme="c" class="ui-btn ui-btn-icon-right ui-li-has-arrow ui-li ui-li-has-count ui-btn-up-c">
						<a href="index.html" class="ui-link-inherit">高级软件工程师/项目经理</a>
					</li>
					<li data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="div" data-icon="arrow-r" 
						data-iconpos="right" data-theme="c" class="ui-btn ui-btn-icon-right ui-li-has-arrow ui-li ui-li-has-count ui-btn-up-c">
						<a href="index.html" class="ui-link-inherit">安卓(Android)开发经理</a>
					</li>
					<li data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="div" data-icon="arrow-r" 
						data-iconpos="right" data-theme="c" class="ui-btn ui-btn-icon-right ui-li-has-arrow ui-li ui-li-has-count ui-btn-up-c">
						<a href="index.html" class="ui-link-inherit">软件产品经理</a>
					</li>
				</ul>
			</div>
