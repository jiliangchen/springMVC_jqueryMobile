...
<html class="index">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="<c:url value='/resources/css/mb/responsiveslides.css' />" />
		...
		<div data-role="page">
			...
			<div id="content" data-role="content">
			    ...
			    <ul class="rslides" id="slider1">
			      <li><img src="<c:url value='/resources/css/images/1.jpg' />" alt=""></li>
			      <li><img src="<c:url value='/resources/css/images/2.jpg' />" alt=""></li>
			      <li><img src="<c:url value='/resources/css/images/3.jpg' />" alt=""></li>
			    </ul>
